...
const Demo = (props) => {
  ...
  // console.log("Props:", props.location.dataProps.sponsordetails.name);
  ...
  const onFinish = (values) => {
    ...
    console.log(file);
    fetch(
      "http://160.119.254.32:3000/sponsor/edit/"+
        props.location.dataProps.sponsordetails.id,
      {
        method: "PUT",
        headers: {
      ...
      .then((res) => {
        res.json().then((data) => {
          if (data.message == "sponsor was updated successfully.") {
